...
@CCPagingSelect
@Parameters(names = {"id","title","description","weight",
		             "shippingAddress","status","recipient",
		             "estimatedDeliveryTime","userPanda" }, 
            types = {Parameters.ParamTypes.Long, 
            		 Parameters.ParamTypes.String,
            		 Parameters.ParamTypes.String, 
            		 Parameters.ParamTypes.Integer,
		             Parameters.ParamTypes.LongArray, 
		             Parameters.ParamTypes.String, 
		             Parameters.ParamTypes.String, 
		             Parameters.ParamTypes.Date,
		             Parameters.ParamTypes.Long})
public class PackageSelectBySearchCriteria {
