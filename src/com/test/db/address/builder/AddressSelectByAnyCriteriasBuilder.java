...
public static interface Param1 {
		Param2 setParam1_CitiesIds(java.util.List<java.lang.Integer> citiesIds);
...
private java.util.List<com.cc.pojo.Param> params = new java.util.ArrayList<com.cc.pojo.Param>();
	...
	public Param2 setParam1_CitiesIds(java.util.List<java.lang.Integer> citiesIds){
		params.add(new com.cc.pojo.Param(com.cc.annotation.Parameters.ParamTypes.IntegerArray, citiesIds));
	return this;
	}
