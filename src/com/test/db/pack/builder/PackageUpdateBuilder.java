...
public class PackageUpdateBuilder{

private static String sqlString = "update panda.package set description = ?,weight = ?,estimated_delivery_time = ?,status = ?, shipping_address = ?,title = ?, recipient = ?  where package_id = ?";
...
public static interface Param3 {
		Param4 setParam3_Estimated_delivery_time(java.util.Date estimated_delivery_time);

}

public static interface Param4 {
		Param5 setParam4_Status(java.lang.String status);

}

public static interface Param5 {
		Param6 setParam5_Shipping_address(java.lang.Long shipping_address);

}

public static interface Param6 {
		Param7 setParam6_Title(java.lang.String title);
...
public static interface Param8 {
		BuildStep setParam8_Package_id(java.lang.Long package_id);
...
private java.util.List<com.cc.pojo.Param> params = new java.util.ArrayList<com.cc.pojo.Param>();
	...
	public Param4 setParam3_Estimated_delivery_time(java.util.Date estimated_delivery_time){
		params.add(new com.cc.pojo.Param(com.cc.annotation.Parameters.ParamTypes.Date, estimated_delivery_time));
	return this;
	}

	public Param5 setParam4_Status(java.lang.String status){
		params.add(new com.cc.pojo.Param(com.cc.annotation.Parameters.ParamTypes.String, status));
	return this;
	}

	public Param6 setParam5_Shipping_address(java.lang.Long shipping_address){
		params.add(new com.cc.pojo.Param(com.cc.annotation.Parameters.ParamTypes.Long, shipping_address));
	return this;
	}

	public Param7 setParam6_Title(java.lang.String title){
	...
	public BuildStep setParam8_Package_id(java.lang.Long package_id){
